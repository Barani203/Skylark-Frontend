...
import bluelogo from "../../assets/skylarklogoblue.png";
import img1 from "../../assets/counterlogo1.png";
import img2 from "../../assets/counterlogo2.png";
import img3 from "../../assets/counterlogo3.png";
import img4 from "../../assets/counterlogo4.png";
import img5 from "../../assets/counterlogo5.png";
import img6 from "../../assets/counterlogo6.png";
const couterData = [
  {
    id: 1,
    img: img2,
            ...
            <Slider {...settings}>
              {jobData.map((data, index) => (
                <div key={index} className="contant">
                  ...
                  <div>
                    <button className="mt-4 px-5 bg-danger py-2 rounded-pill">
                      Contact Us
                    </button>
                  </div>
                </div>
